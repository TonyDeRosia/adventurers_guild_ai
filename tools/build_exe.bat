...
call :step "[4/6] Auditing packaging inputs"
...
if errorlevel 1 call :fail "[4/6] Auditing packaging inputs" "Pre-build audit failed."
call :pass "[4/6] Auditing packaging inputs" "Packaging input audit passed."
...
call :step "[6/6] Post-build distribution audit"
call %PYTHON_CMD% tools\audit_distribution.py ^
...
if errorlevel 1 call :fail "[6/6] Post-build distribution audit" "Post-build audit failed."
call :pass "[6/6] Post-build distribution audit" "Distribution audit passed."

call :log SUCCESS: Build complete.
call :log Output: dist\AdventurerGuildAI\AdventurerGuildAI.exe
call :log Log file: %LOG_FILE%
